jsPlumb.ready(function() {
    ...
    $.ajax({
        url: '/networks/name:texturejade',
        success: function(result) {
            $.ajax({
                url: '/networks/name:texturejade?format=graph',
                success: function(layoutdata) {
                    ...
                    for ( var modulename in modules ) {
                        $('#flowchart-demo').append("<div class='window' style='top:"+layoutdata[modulename].y+";left:"+layoutdata[modulename].x+"' id='module_"+modulename+"'>"+modulename+":"+modules[modulename].type+"<br /><img src='/networks/name:texturejade/modules/"+modulename+"?format=jpg&height=128&width=128&EnableLight=false&gradient=jade'/></div>");
                    }
